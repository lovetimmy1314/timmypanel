...
- Floating weather widget in the top-left corner on desktop (optional, never shown on phones): pick a city or district, or use browser geolocation — the server fetches and caches it, your browser never talks to the weather API
